...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2024 at 04:37 PM
...
(8, '177106101219690001', 'harrywitriyono', 'Harry Witriyono', 'Admin', '1311094102', 7, 7, 'III B', 'Aktif'),
...
--
ALTER TABLE `pengguna`
  MODIFY `id_login` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `pesertakegiatan`
--
ALTER TABLE `pesertakegiatan`
  MODIFY `idPeserta` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
